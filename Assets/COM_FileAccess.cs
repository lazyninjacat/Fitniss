...
public static class FileAccessUtil
{
    ...
    static string PICTURE_DIRECTORY = Application.persistentDataPath + "/Pictures";
    static string AUDIO_DIRECTORY = Application.persistentDataPath + "/Audio";
    ...
    public static bool DoesAudioExist(string audioID) { return File.Exists(AUDIO_DIRECTORY + "/" + audioID + ".wav"); }
    public static bool DoesPicExist(string picID) { return File.Exists(PICTURE_DIRECTORY + "/" + picID + ".png"); }
    ...
    public static void DeletePictures(List<string> filesToDelete, string picID) { DeletePicturesFromDir(filesToDelete, PICTURE_DIRECTORY, picID); }

    // All the public facing save methods
    public static bool SavePic(Texture2D photo, string fileName) { return SavePhotoToDir(photo, fileName, PICTURE_DIRECTORY); }
    public static bool SaveAudio(AudioClip clip, string fileName) { return SaveAudioToDir(clip, fileName, AUDIO_DIRECTORY); }

    // All the public facing Load methods
    public static byte[] LoadPic(string fileName) { return LoadPhotoByDir(fileName, PICTURE_DIRECTORY); }
    public static AudioClip LoadAudio(string fileName) { return LoadAudioByDir(fileName, AUDIO_DIRECTORY); }

    // All the public facing Delete methods
    public static void DeletePic(string fileName) { DeleteImageFromDir(fileName, PICTURE_DIRECTORY); }
    public static void DeleteAudio(string fileName) { DeleteAudioFromDir(fileName, AUDIO_DIRECTORY); }

    // All the public facing picture recovery methods
    public static List<byte[]> RetrievePics(string fileName) { return RetrievePics(fileName, PICTURE_DIRECTORY); }


    // All the public facing picture collection saving methods
    public static List<string> SavePics(List<Texture2D> texList, string fileName, List<string> namesList = null) { return SavePics(texList, fileName, PICTURE_DIRECTORY, namesList); }

    // All the public facing random picture selction methods
    public static byte[] LoadRandomPic(string fileName) { return LoadRandomPic(fileName, PICTURE_DIRECTORY); }

    public static string[] GetImagePaths(string fileName) { return GetImageFilePathArray(PICTURE_DIRECTORY + "/" + fileName.ToLower() + "/"); }
    public static bool DeleteImageDir(string fileName) { return DeleteDirectory(fileName, PICTURE_DIRECTORY); }
    ...
    */
    ...
    private static void DeletePicturesFromDir(List<string> filesToDelete, string directory, string picID)
    {
        foreach (string fileName in filesToDelete)
        {
            Debug.Log("******************************\n DELETEING FILE " +fileName+ "\n****************************");
            File.Delete(directory + "/" + picID + "/" + fileName);
        }
    }
