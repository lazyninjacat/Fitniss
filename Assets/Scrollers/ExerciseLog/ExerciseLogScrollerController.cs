...
/// </summary>
public class ExerciseLogScrollerController : MonoBehaviour, IEnhancedScrollerDelegate
{
    /// <summary>
    /// Internal representation of our data. Note that the scroller will never see
    /// this, so it separates the data from the layout using MVC principles.
    /// </summary>
    private SmallList<ExerciseLogScrollerData> _data;
    ...
    private void LoadLargeData()
    {
        ...
        _data = new SmallList<ExerciseLogScrollerData>();


        foreach (var row in dataService.GetExerciseLogTable())
        {      

            _data.Add(new ExerciseLogScrollerData() { 
                exerciseName = row.ExerciseName,
                exerciseAmount = row.ExerciseAmount,
    ...
    public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
    {
        ...
        ExerciseLogCellView cellView = scroller.GetCellView(cellViewPrefab) as ExerciseLogCellView;
